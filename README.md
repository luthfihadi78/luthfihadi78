...
| Layer | What it does |
|:--|:--|
| **Signal engines** | Read live futures data across ~450 symbols, in real time |
| **Backtesting** | 700+ days of history, walk-forward and out-of-sample splits |
| **Statistical gating** | Deflated Sharpe, PBO, purged cross-validation — a strategy has to *earn* production |
...
**📱 Project K3** — *private repository* · Flutter

A cross-platform mobile application built with Flutter and Dart.

<br />

**🤖 Android · Kotlin** — native Android is where I'm strongest, and most of that work
isn't published here. So take this profile as understating it: the public repositories
below are where I *started*, not where I am now.

<br />

**📚 Public repos** — my earlier Android, Java and JavaScript coursework from
[Dicoding](https://www.dicoding.com/) is still up, on purpose. It's an honest record
of the beginning.
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/luthfihadi78/luthfihadi78/output/github-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/luthfihadi78/luthfihadi78/output/github-snake.svg" />
  <img src="https://raw.githubusercontent.com/luthfihadi78/luthfihadi78/output/github-snake.svg" width="100%" alt="Snake eating my contribution graph" />
</picture>
